...
const ProductDetails = () => {
    ...
    return product && (
        <div className="mt-12">
            ...
            <button className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition" onClick={() => {navigate('/products'); scrollTo(0,0)}}>
                See more
            </button>
        </div>
     </div>
