    ...
    <div className='relative'>
      <img src={assets.main_banner_bg} alt='banner' className='w-full hidden md:block'/>
       ...
       <div className='flex items-center mt-6 font-medium'>
        ...
        Shop now <img src={assets.white_arrow_icon} alt='arrow' className='md:hidden trasition group-focus:translate-x-1'/>
        </Link>

        <Link to={'/products'} className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer'>
        Explore deals <img src={assets.black_arrow_icon} alt='arrow' className='trasition group-hover:translate-x-1'/>
        </Link>
         </div>
        </div>
       </div>
