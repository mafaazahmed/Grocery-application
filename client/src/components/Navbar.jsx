...
const Navbar = () => {
    ...
    const [showMobileSearch, setShowMobileSearch] = React.useState(false); // NEW STATE
  ...
  return (
     ...
     <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {!user ? (<button onClick={() => setShowUserLogin(true)} className="cursor-pointer px-8 py-2 bg-primary hover:bg-primary-dull transition text-white rounded-full">
                    ...
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow  py-2.5 w-30 rounded-md text-sm z-40'>
            ...
            <div className='flex items-center gap-6 sm:hidden'>
                {/* Search Icon */}
                <div onClick={() => setShowMobileSearch(prev => !prev)} className="cursor-pointer">
     ...
     {/* Mobile Search Bar */}
     {showMobileSearch && (
        <div className="sm:hidden border-b border-gray-300 px-4 py-2 bg-white">
